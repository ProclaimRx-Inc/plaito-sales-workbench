...
export const IDEAS: Idea[] = [
  {
    ...
    href: "/pulse",
    status: "Prototyped",
    problem: "The most common prompts are the simplest — how did we do last week, what is TRx since launch, which week was best — and the follow-up is always 'why'. Each answer today is a fresh SQL guess with a fresh narrative.",
    quotes: ["how did we do last week", "which week was our best ever for escitalopram trx", "What is the most recent week of Rx data available?", "Why did Escitalopram prescriptions decline this week?"],
  ...
  },
  {
    ...
    quotes: ["Provide a listing of new prescribers of Escitalopram for the week ending 3/6/26 … defined purely on TRx units (tunits)", "How many HCPs have written Escitalopram in 10 or more separate weeks?", "Which new writers have not written a second prescription?"],
  ...
  },
  {
    ...
    quotes: ["Can you tell me where zip 43215 is aligned?", "Provide 13 week MDD Market TRx, Commercial TRx, Medicare TRx, Medicaid TRx, Medicaid Branded TRx, Medicaid Generic TRx, Tricare TRx, Medicaid Escitalopram TRx by territory number", "How many active territories do we have?"],
  ...
  },
  {
    ...
    quotes: ["identify non-Escitalopram writers in white space that may have a higher likelihood of prescribing Escitalopram", "Is there a corrrelation between our top writers and their Buspar volume?", "Which 10 HCPs should I prioritize this week and why?"],
  ...
  },
  {
    ...
    quotes: ["How many current Priority (Tier_A) targets received zero Escitalopram calls in Q2 2026?", "number of calls prior to the 1st Escitalopram TRx being written", "Here are the NPIs and speaker program dates. I will provide instructions once you confirm your ability to read in the data."],
  ...
  },
  {
    ...
    quotes: ["Show actual sales, goal, and variance for each territory.", "Which territories are currently below 80% of goal?", "How many additional Escitalopram prescriptions does each territory need to reach goal?"],
  ...
  },
  {
    ...
    href: null,
    status: "Proposed",
    problem: "Unasked so far, but 50 taxonomy prompts want accounts ranked by Escitalopram volume, writers added/lost in 90 days, and share vs market volume. The HCP master carries an account id, so this is the territory scorecard grouped differently.",
    quotes: ["Which accounts have high market volume but low Escitalopram share?", "Which health systems have added new Escitalopram prescribers in the last 90 days?"],
  ...
  },
  {
    ...
    quotes: ["can you project Escitalopram TRx by week through the end of 2026 with conservative, base, and aggressive case scenarios"],
